...
const TeamCard = () => {
    return (
        <div className="rounded-2xl border-black border-[1px] flex flex-col items-center p-[80px] gap-5">
            <img src="img/nft5.png" className="rounded-full w-full md:w-[300px] h-auto" alt="" />
            <p className="uppercase text-[36px] font-bold font-gulf text-[black]">Sam</p>
            <p className="uppercase text-[18px] font-bold text-[#535353] text-center">Developer & co-founder</p>
